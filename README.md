...
$ composer config repositories.weltpixel-magento2-weltpixel-lazyload git https://github.com/Weltpixel/magento2-weltpixel-lazyload.git
$ composer require weltpixel/magento2-weltpixel-lazyload:dev-master
```
...
Copy the zip into the app/code/WeltPixel/LazyLoading directory
...
For detailed documentation, please visit: https://weltpixel.com/resources/ModuleDoc/Magento2/LazyLoading/User-Guide-WeltPixel-LazyLoading-Magento2.html
